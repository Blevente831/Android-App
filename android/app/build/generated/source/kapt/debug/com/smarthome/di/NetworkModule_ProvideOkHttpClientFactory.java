...
public final class NetworkModule_ProvideOkHttpClientFactory implements Factory<OkHttpClient> {
  ...
  public OkHttpClient get() {
    return provideOkHttpClient(smartNetworkInterceptorProvider.get(), authInterceptorProvider.get());
  }

  public static NetworkModule_ProvideOkHttpClientFactory create(
      Provider<SmartNetworkInterceptor> smartNetworkInterceptorProvider,
      Provider<Interceptor> authInterceptorProvider) {
    return new NetworkModule_ProvideOkHttpClientFactory(smartNetworkInterceptorProvider, authInterceptorProvider);
  }

  public static OkHttpClient provideOkHttpClient(SmartNetworkInterceptor smartNetworkInterceptor,
      Interceptor authInterceptor) {
    return Preconditions.checkNotNullFromProvides(NetworkModule.INSTANCE.provideOkHttpClient(smartNetworkInterceptor, authInterceptor));
  }
}
